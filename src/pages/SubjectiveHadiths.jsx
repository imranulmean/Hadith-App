    ...
    const getSubjectiveHadiths=async()=>{
        ...
        try{
            ...
            if (Capacitor.isNativePlatform()) {
                ...
                const result = await db.query(`SELECT DISTINCT bookId, bookName FROM subjectives ORDER By bookId`);
            ...
            const result = db.exec(`SELECT DISTINCT bookId, bookName FROM subjectives ORDER By bookId`);
